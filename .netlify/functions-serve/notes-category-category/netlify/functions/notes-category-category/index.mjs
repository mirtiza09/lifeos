...
// netlify/functions/notes-category-category/index.js
...
// netlify/api/notes/category/[category].js
var category_default = withErrorHandler(async function handler(req, res) {
...
var expressToNetlify = async (req, context) => {
  ...
  await category_default(mockReq, mockRes);
  return new Response(
