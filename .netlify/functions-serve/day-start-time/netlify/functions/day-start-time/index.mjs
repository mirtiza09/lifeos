...
// netlify/functions/day-start-time/index.js
...
var day_start_time_default = withErrorHandler(dayStartTimeHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await day_start_time_default(mockReq, mockRes);
  return new Response(
...
var day_start_time_default2 = async (req, context) => {
