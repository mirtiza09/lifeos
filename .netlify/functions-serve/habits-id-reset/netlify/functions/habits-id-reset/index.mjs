...
// netlify/functions/habits-id-reset/index.js
...
// netlify/api/habits/[id]/reset.js
...
var reset_default = withErrorHandler(resetHabitHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await reset_default(mockReq, mockRes);
  return new Response(
