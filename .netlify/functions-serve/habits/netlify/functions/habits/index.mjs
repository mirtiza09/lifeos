...
// netlify/functions/habits/index.js
  ...
  if (req.method === "POST") {
    try {
      ...
      const habit = await storage.createHabit({
        name,
        type,
        currentValue: type === "counter" ? 0 : void 0,
        maxValue: type === "counter" ? maxValue : void 0,
        repeatType,
        repeatDays,
        status: "pending",
        createdAt: (/* @__PURE__ */ new Date()).toISOString(),
...
var habits_default = withErrorHandler(habitsHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await habits_default(mockReq, mockRes);
  return new Response(
...
var habits_default2 = async (req, context) => {
