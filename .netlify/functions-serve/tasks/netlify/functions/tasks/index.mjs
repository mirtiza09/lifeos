...
// netlify/functions/tasks/index.js
...
var tasks_default = withErrorHandler(tasksHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await tasks_default(mockReq, mockRes);
  return new Response(
...
var tasks_default2 = async (req, context) => {
