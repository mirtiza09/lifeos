...
// netlify/functions/habits-id-fail/index.js
...
var fail_default = withErrorHandler(failHabitHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await fail_default(mockReq, mockRes);
  return new Response(
