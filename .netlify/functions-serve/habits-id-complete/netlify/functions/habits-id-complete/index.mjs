...
// netlify/functions/habits-id-complete/index.js
...
// netlify/api/habits/[id]/complete.js
...
var complete_default = withErrorHandler(completeHabitHandler);
...
var expressToNetlify = async (req, context) => {
  ...
  await complete_default(mockReq, mockRes);
  return new Response(
